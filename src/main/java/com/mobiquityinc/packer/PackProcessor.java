...
public class PackProcessor {
     ...
     * <p>
     * The result package is a new Pack instance, containing the item that sum the highest cost, without excceding the maximum weight of
     ...
     * <p>
     * It is a slightly modified implementation of a <a href='https://en.wikipedia.org/wiki/Power_set'>powerset</a>, tweaked
     * to be more performatic by eliminating the combinations that don't fit the weight constraints.
     * <p>
     * Steps:
     * <ul>
     * <li>1. Sorts all the items that can be chosed, by highest cost/lowest weight;</li>
     ...
     * <li>6. The actual matcher loop, that will try the reamaining possible combinations for the item;</li>
     ...
     * </ul>
     *
     * @param allItems a pack contained all items that can be chosed
    ...
    /**
     * Validates a pack, according to the folowing rules:
     * <ul>
